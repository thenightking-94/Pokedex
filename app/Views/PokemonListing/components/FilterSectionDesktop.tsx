                ...
                <Grid item sm={4}>
                    <div className="type-section">
                        ...
                        <FormControl className="type-checkbox">
                            <InputLabel id="checkbox-label-type">
                                <span className="desc">{'Normal'}</span>
                                <span className="bold">{' +5 More'}</span>
                            </InputLabel>
                            <Select
                            ...
                            >
                                {PokemonTypes?.map((i) => (
                                    ...
                                    >
                                        <Checkbox
                                            checked={
                                                pokemonTypeDataFiltered.indexOf(
                                                    i
                                                ) > -1
                                            }
                                        />
                ...
                <Grid item sm={4}>
                    <div className="gender-section">
                        ...
                        <FormControl className="gender-checkbox">
                            <InputLabel id="checkbox-label-gender">
                                <span className="desc">{'Male'}</span>
                                <span className="bold">{' +2 More'}</span>
                            </InputLabel>
                            <Select
                            ...
                            >
                                {PokemonGender?.map((i) => (
                                    ...
                                    >
                                        <Checkbox
                                            checked={
                                                pokemonGenderDataFiltered.indexOf(
                                                    i
                                                ) > -1
                                            }
                                        />
